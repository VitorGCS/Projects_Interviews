...
import uk.nominet.techtest.VitorSilva.towers.model.*;

import java.util.List;


//describe all the test scenarios -> List of TestScenarios
public abstract class TestScenarios {
	//ImmutableList.of(list) returns a ImmutableList<List<String>>
	 //ImmutableList.of(list<E>)} returns an ImmutableList<List<E>> containing one element (the given list itself).
